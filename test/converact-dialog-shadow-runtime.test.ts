...
const BASE_ENV: NodeJS.ProcessEnv = {
  CONVERACT_FABRIC_DIALOG_SHADOW_CELL_ID: 'cell-a',
  CONVERACT_FABRIC_DIALOG_SHADOW_NODE_ID: 'rustpbx-a',
  CONVERACT_FABRIC_DIALOG_SHADOW_FAULT_DOMAIN: 'zone-a-rack-1',
  CONVERACT_FABRIC_DIALOG_SHADOW_JOURNAL_PATH: '/var/lib/converact/dialog-shadow.wal',
  CONVERACT_FABRIC_DIALOG_SHADOW_SERVICE_TOKEN_FILE: '/run/secrets/dialog-shadow-token',
  CONVERACT_FABRIC_DIALOG_SHADOW_TLS_KEY_FILE: '/run/tls/tls.key',
  CONVERACT_FABRIC_DIALOG_SHADOW_TLS_CERT_FILE: '/run/tls/tls.crt',
  CONVERACT_FABRIC_DIALOG_SHADOW_TLS_CA_FILE: '/run/tls/ca.crt',
  CONVERACT_FABRIC_DIALOG_SHADOW_SPIFFE_TRUST_DOMAIN: 'converact.internal',
  CONVERACT_FABRIC_DIALOG_RECOVERY_DATABASE_URL_FILE:
    '/run/secrets/dialog-recovery-database-url',
  CONVERACT_FABRIC_DIALOG_RECOVERY_CURRENT_KEY_ID: 'recovery-2026-07',
  CONVERACT_FABRIC_DIALOG_RECOVERY_CURRENT_KEY_FILE:
    '/run/secrets/dialog-recovery-current-key',
  CONVERACT_FABRIC_DIALOG_RECOVERY_PREVIOUS_KEY_ID: 'recovery-2026-06',
  CONVERACT_FABRIC_DIALOG_RECOVERY_PREVIOUS_KEY_FILE:
    '/run/secrets/dialog-recovery-previous-key',
  CONVERACT_FABRIC_DIALOG_SHADOW_NATS_SERVER_FAULT_DOMAINS_FILE:
    '/etc/converact/nats-fault-domains.json',
  CONVERACT_FABRIC_DIALOG_SHADOW_NATS_PLACEMENT_CLUSTER: 'cell-a',
  CONVERACT_FABRIC_DIALOG_SHADOW_NATS_PLACEMENT_TAGS: 'cell:cell-a,role:dialog-shadow',
...
const FILES: Record<string, string> = {
  ...
  '/etc/converact/nats-fault-domains.json': JSON.stringify({
...
test('dialog shadow production runtime rejects plaintext and inline secrets', () => {
  ...
  assert.throws(
    () => loadDialogShadowAgentConfig({
      ...BASE_ENV,
      CONVERACT_FABRIC_DIALOG_RECOVERY_DATABASE_URL_FILE: undefined,
      CONVERACT_FABRIC_DIALOG_RECOVERY_DATABASE_URL:
        'postgresql://opc_runtime:password@postgres.internal:5432/opc'
    }, readFixture),
  ...
  assert.throws(
    () => loadDialogShadowAgentConfig({
      ...BASE_ENV,
      CONVERACT_FABRIC_DIALOG_RECOVERY_CURRENT_KEY_FILE: undefined,
      CONVERACT_FABRIC_DIALOG_RECOVERY_CURRENT_KEY:
