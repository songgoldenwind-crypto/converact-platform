...
} from '../scripts/converact-voice-media-goal1-acceptance.js';
...
describe('Converact Fabric voice media Goal 1 controlled acceptance', () => {
  it('writes bounded evidence for every Goal 1 failure and recovery invariant', async () => {
    const outputDir = mkdtempSync(join(tmpdir(), 'converact-media-goal1-'));
