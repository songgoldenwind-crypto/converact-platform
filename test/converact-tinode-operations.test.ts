...
test('Converact Fabric Tinode operations facade is admin-only, tenant-scoped, and emits replay audit events', async () => {
...
test('Converact Fabric SDK maps Tinode operations and both dead-letter families', async () => {
