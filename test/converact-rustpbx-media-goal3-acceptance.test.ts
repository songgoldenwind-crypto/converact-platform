...
test('Goal 3 acceptance CLI is exposed through the root package', () => {
  ...
  assert.equal(
    packageJson.scripts['converact:rustpbx-media-goal3:acceptance'],
    'node --import tsx scripts/converact-rustpbx-media-goal3-acceptance.ts'
  );
});
...
function validInput(): RustPbxMediaGoal3AcceptanceInput {
  ...
  return {
    ...
    environment: {
      ...
      project_name: 'converact-goal3-62c7795',
