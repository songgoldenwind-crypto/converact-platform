...
test('Converact Fabric SDK exposes the complete Contact Center control plane', () => {
  const sdk = createConveractFabricHttpSdk({
    baseUrl: 'https://converact.example/', tenantId: 'tenant-a', apiKey: 'api-key',
...
test('Converact Fabric Contact Center client preserves paths filters bodies and idempotency', async () => {
...
test('unified Converact Fabric client includes Contact Center alongside reusable media and remote clients', () => {
