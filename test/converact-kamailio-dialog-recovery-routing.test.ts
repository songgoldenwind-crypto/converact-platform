...
const SECRETS = {
  topoh_mask_key: 'converact-topology-mask-key-1234567890abcdef',
  rpc_bearer_token: 'converact-kamailio-rpc-token-1234567890abcdef',
  webphone_jwt_secret: 'converact-webphone-jwt-secret-1234567890abcdef'
};
