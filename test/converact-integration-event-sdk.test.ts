...
test('Converact Fabric SDK exposes event catalog and webhook subscription administration', async () => {
  ...
  const client = createConveractFabricHttpSdk({
    baseUrl: 'https://fabric.converact.example.com', tenantId: 'tenant-1', apiKey: 'server-key',
