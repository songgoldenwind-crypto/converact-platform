...
test('Converact Fabric SDK exposes the complete Voice control plane', () => {
  const sdk = createConveractFabricHttpSdk({
    baseUrl: 'https://converact.example/',
    tenantId: 'tenant-a',
    apiKey: 'api-key',
...
test('Converact Fabric Voice client preserves paths, filters, request bodies, and idempotency keys', async () => {
...
test('unified Converact Fabric client includes Voice without coupling RustDesk lifecycle', () => {
