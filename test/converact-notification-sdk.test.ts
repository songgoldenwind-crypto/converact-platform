...
test('Converact Fabric SDK exposes notification creation inbox templates preferences and endpoints', () => {
  const sdk = createConveractFabricHttpSdk({
    baseUrl: 'https://converact.example/', tenantId: 'tenant-a', apiKey: 'key-a',
...
test('Converact Fabric notification SDK preserves encoded paths, actor scope and idempotency headers', async () => {
