...
test('intelligence HTTP exposes public capabilities but protects policy and profile administration', async () => {
  ...
  try {
    const put = await routeConveractFabricIntelligenceApi(
      pg,
      'PUT',
    ...
    const capabilities = await routeConveractFabricIntelligenceApi(
      pg,
      'GET',
    ...
    const providers = await routeConveractFabricIntelligenceApi(
      pg,
      'GET',
    ...
    const runtime = await routeConveractFabricIntelligenceApi(
      pg,
      'GET',
    ...
    const policy = await routeConveractFabricIntelligenceApi(
      pg,
      'GET',
      '/api/ivekit/intelligence/policy',
      new URL('http://localhost/api/ivekit/intelligence/policy'),
