...
const API_KEY = 'converact-secure-file-http-key';
...
async function httpFixture(
  ...
  const root = mkdtempSync(join(tmpdir(), 'converact-secure-file-http-'));
  t.after(() => {
  ...
  const options: RouteConveractFabricChatApiOptions = {
