...
**Tech Stack:** TypeScript/Node.js, Rust/Tokio, PostgreSQL, JSON Schema 2020-12, Kamailio, RTPengine, RustPBX/rsipstack, selected exact-source rvoip slices, LiveKit SIP, LiveKit, existing Converact Fabric capacity/evidence framework.

---

## Execution invariants

- Execute only from the canonical Converact worktree declared by `goals/PROGRAM-RULES.md` and the
  active Goal branch. `/Users/songjinfeng/Projects/opc-worktrees/ivekit-v3` is a read-only legacy
  source and must never become the execution root again.
...
- Keep `current`, `target`, `not_run`, `verified`, and
  ...
  cannot authorize Converact Fabric production claims.
...
- Test: `test/converact-unified-voice-foundation-r4-contract.test.ts`
...
12. Run:
   ...
   ```bash
   node --import tsx --test test/converact-unified-voice-foundation-r4-contract.test.ts
   ```
...
- Create: `test/converact-unified-voice-foundation-r4-traceability.test.ts`
- Modify: `test/converact-unified-voice-foundation-r4-contract.test.ts`
...
- Modify: `docs/design/rvoip-converact-communication-foundation-integration-design.md`
...
- Modify: `test/converact-rvoip-capability-integration.test.ts`
...
1. Run:
   ...
   node --import tsx --test \
     test/converact-unified-voice-foundation-r4-contract.test.ts \
     test/converact-unified-voice-foundation-r4-traceability.test.ts \
     test/converact-unified-voice-authority-binding.test.ts \
     test/converact-rvoip-capability-integration.test.ts \
     test/component-governance.test.ts
   npm run test:converact:voice-media-goal4
...
- Create: `src/agent-runtime/converact/voice/sip-foundation/types.ts`
- Create: `src/agent-runtime/converact/voice/sip-foundation/capabilities.ts`
- Create: `src/agent-runtime/converact/voice/sip-foundation/rsipstack-adapter.ts`
- Test: `test/converact-sip-foundation.test.ts`
...
- Create: `src/agent-runtime/converact/voice/sip-foundation/effect-oracle.ts`
- Create: `src/agent-runtime/converact/voice/sip-foundation/postgres-effect-store.ts`
- Create: `src/agent-runtime/converact/voice/sip-foundation/migrations/001_effect_oracle.sql`
- Test: `test/converact-sip-effect-oracle.test.ts`
...
- Create: `src/agent-runtime/converact/voice/sip-foundation/recovery.ts`
- Test: `test/converact-sip-foundation-recovery.test.ts`
...
- Create: `infra/converact/rtpengine/patches/rtpengine-ivekit-atomic-binding-lifecycle-v1.patch`
- Modify: `infra/converact/rtpengine/manifest.json`
- Test: `test/converact-rtpengine-atomic-binding-lifecycle.test.ts`
...
1. Write source/static tests for group ID/generation, member-flow fence digest,
   ...
   query, and replay.
2. Patch exact-source RTPengine or its bounded Converact Fabric agent only where the
...
- Modify: `infra/converact/rustpbx/src/media_engine_facade.rs`
- Modify: `infra/converact/rustpbx/src/media_plan.rs`
- Test: `test/converact-media-binding-lifecycle.test.ts`
...
- Create: `src/agent-runtime/converact/voice/sip-foundation/rvoip-shadow.ts`
- Test: `test/converact-rvoip-sip-shadow.test.ts`
...
- Modify: `src/agent-runtime/converact/voice/ports.ts`
- Modify: `src/agent-runtime/converact/voice/types.ts`
- Create: `src/agent-runtime/converact/voice/postgres/media-bridge-store.ts`
- Create: `src/agent-runtime/converact/voice/postgres/migrations/002_media_bridge_generation.sql`
- Test: `test/converact-voice-media-bridge-store.test.ts`
...
- Modify: `src/agent-runtime/converact/voice/adapters/livekit-sip.ts`
- Create: `src/agent-runtime/converact/voice/livekit-handoff.ts`
- Modify: `src/agent-runtime/converact/voice/runtime.ts`
- Test: `test/converact-livekit-handoff.test.ts`
