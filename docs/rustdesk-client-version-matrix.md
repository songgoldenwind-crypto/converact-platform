...
> Contract freeze: 2026-07-12. This matrix is the iveKit real-terminal V1
...
| --- | --- | --- | --- |
| RustDesk OSS server | `rustdesk/rustdesk-server:1.1.15` | `linux/amd64`, `linux/arm64` | [RustDesk Server 1.1.15 release](https://github.com/rustdesk/rustdesk-server/releases/tag/1.1.15) |
| RustDesk OSS client 1.4.7 | `1.4.7` stable | See platform table | [RustDesk 1.4.7 release](https://github.com/rustdesk/rustdesk/releases/tag/1.4.7) |

Only the exact `1.1.15` server and `1.4.7` client combination is in the V1
...
Client `1.4.7` is the V1 target because its stable release includes relevant
security, reconnect, and file-transfer fixes over the previous baseline.
