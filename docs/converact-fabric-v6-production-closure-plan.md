# Converact Fabric V6 Production Closure Implementation Plan
...
**Architecture:** Converact Fabric 保持权威控制面，外部执行统一使用 PostgreSQL durable outbox/command、lease fencing、幂等完成与 dead letter。Windows companion 只执行 capability manifest 允许的本地动作，所有内容证据进入 secure-file 链路。
...
- Create: `services/converact-service/helm/converact/templates/tinode-config.yaml`
- Create: `services/converact-service/helm/converact/templates/tinode-deployment.yaml`
- Create: `services/converact-service/helm/converact/templates/tinode-service.yaml`
- Create: `services/converact-service/helm/converact/templates/tinode-pvc.yaml`
- Create: `services/converact-service/helm/converact/templates/tinode-pdb.yaml`
- Modify: `services/converact-service/helm/converact/templates/_helpers.tpl`
- Modify: `services/converact-service/helm/converact/templates/deployment.yaml`
- Modify: `services/converact-service/helm/converact/values.yaml`
- Modify: `services/converact-service/helm/converact/README.md`
- Create: `src/agent-runtime/collaboration/tinode-service-account-bootstrap.ts`
- Create: `src/converact-tinode-bootstrap.ts`
- Test: `test/converact-tinode-helm-deployment.test.ts`
...
- [x] Add ConfigMap/Deployment/Service/PVC/PDB templates and Converact Fabric internal URL wiring.
...
- Create: `docs/converact-fabric-v6-real-environment-acceptance.md`
- Create: `scripts/converact-v6-real-acceptance.ts`
- Modify: `scripts/converact-delivery-bundle.ts`
- Modify: `docs/converact-led-integration-guide.md`
- Modify: `docs/converact-fabric-v3-completion-audit.md`
- Modify: `docs/openapi.yaml`
- Modify: `sdk/converact/README.md`
- Test: `test/converact-v6-real-acceptance.test.ts`
- Test: `test/converact-delivery-bundle.test.ts`
