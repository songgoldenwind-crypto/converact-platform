# Converact Fabric Tinode Fork Build
...
CONVERACT_FABRIC_TINODE_IMAGE=registry.example.com/converact/tinode:v0.25.3-ivekit.3 \
CONVERACT_FABRIC_TINODE_BUILDER_IMAGE=docker.io/library/golang:1.26-alpine@sha256:<digest> \
CONVERACT_FABRIC_TINODE_RUNTIME_IMAGE=docker.io/library/bash:5.3-alpine3.23@sha256:<digest> \
CONVERACT_FABRIC_TINODE_TARGETARCH=amd64 \
bash infra/converact/tinode/build-converact.sh
```
...
`converact/tinode:v0.25.3-ivekit.2-22a7c18e-amd64`, image ID
...
Converact Fabric component-node marker passed inspection. The earlier local arm64 build
...
`converact/tinode:v0.25.3-ivekit.3-22a7c18e-amd64`, image ID
