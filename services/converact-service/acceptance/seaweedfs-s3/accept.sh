...
COMPOSE_FILE="$ROOT_DIR/services/converact-service/acceptance/seaweedfs-s3/docker-compose.yml"
PROBE="$ROOT_DIR/services/converact-service/acceptance/seaweedfs-s3/probe.ts"
...
export CONVERACT_OBJECT_STORAGE_REQUIRED=1 NODE_NO_WARNINGS=1
