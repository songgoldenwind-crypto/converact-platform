...
ACCEPTANCE_DIR="$ROOT_DIR/services/converact-service/acceptance/realtime-recovery"
...
AI_AGENT_IMAGE=${AI_AGENT_IMAGE:-converact-validation/ai-agent:provider-fallback@sha256:0f83a1c0814365dddff5d3d917751a9f6928e8a06c359f39d50b122664c8a74b}
PYTHON_TEST_DEPS=${PYTHON_TEST_DEPS:-/opt/converact-wave123-validation-20260722/cache/python-test-deps}
POSTGRES_HOST_PORT=${POSTGRES_HOST_PORT:-}
GATEWAY_PORT=${GATEWAY_PORT:-0}
AUTHORIZATION_PORT=${AUTHORIZATION_PORT:-0}
MAX_PORT_BIND_ATTEMPTS=3
PROJECT="converact-realtime-recovery-$(date -u +%Y%m%d%H%M%S)-$$"
RUN_ID="$PROJECT"
WORK_DIR=$(mktemp -d "${TMPDIR:-/tmp}/converact-realtime-recovery.XXXXXX")
