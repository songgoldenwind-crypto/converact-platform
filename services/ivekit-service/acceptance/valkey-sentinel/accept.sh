...
COMPOSE_FILE="$ROOT_DIR/services/ivekit-service/acceptance/valkey-sentinel/docker-compose.yml"
...
run_probe() {
  ...
  timeout 30 docker run --rm \
    ...
    node --import tsx services/ivekit-service/acceptance/valkey-sentinel/probe.ts \
    >"$output_file"
}
...
acceptance_source_sha256=$(
  cd "$ROOT_DIR"
  sha256sum \
    services/ivekit-service/acceptance/valkey-sentinel/accept.sh \
    services/ivekit-service/acceptance/valkey-sentinel/docker-compose.yml \
    services/ivekit-service/acceptance/valkey-sentinel/probe.ts \
