"""HTTP client for Converact call-center APIs."""
...
logger = logging.getLogger("ai-agent.converact")


class ConveractClient:
...
# Compatibility-only name. New code imports ConveractClient; keeping this as
# the same class object prevents a second client implementation or state model.
OPCClient = ConveractClient

__all__ = ["ConveractClient", "OPCClient"]
