...
9. `.73` wires the matched-CANCEL capability holder into the Rust session path
   ...
   `not_run` under the safe memory ceiling. Next wire ordinary response
   authority, UAS-2xx and reconciliation resume. Close parent-Unknown and stale-
