...
| RustPBX/rsipstack runtime | `infra/converact/rustpbx/build.sh` and patch queue | RustPBX `6c49ee76…`, rsipstack `8318e97b…`, rustrtc `166c6d22…`, patchset `ivekit.42` are pinned; rsipstack passes 270/270 and the repaired RustPBX candidate passes 1913/1913 non-ignored native library tests | current Adapter baseline; clean commit-bound build and wire/capacity gates remain `not_run` |
