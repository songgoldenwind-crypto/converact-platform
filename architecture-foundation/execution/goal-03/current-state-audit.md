...
| RustPBX/rsipstack runtime | `infra/converact/rustpbx/build.sh` and patch queue | RustPBX `6c49ee76…`, rsipstack `8318e97b…`, rustrtc `166c6d22…`, patchset `ivekit.41` are pinned; the complete rsipstack queue passes 270/270 local native tests | current Adapter baseline; no full-stack replacement in G03 |
