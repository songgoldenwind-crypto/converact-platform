...
recovered admission rejection, and current `.84` makes loss of either recovered
Dialog worker visible to the sole controller. It does not prove actual live-task panic
