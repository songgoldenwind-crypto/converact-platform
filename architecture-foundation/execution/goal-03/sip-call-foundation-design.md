...
The current `.81` delta adds only the local recovered Active Call composition
described above. It does not prove real restart wiring, a live peer, original-
INVITE Oracle activation, Endpoint activation or Native Authority, so none of
those states is promoted.
