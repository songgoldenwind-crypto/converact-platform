...
The `.73` matched-CANCEL results are local functional component checks only.
They neither replace `.72` Linux evidence nor start a load campaign. Isolated
server functional traffic, remaining transports, product activation and every
