...
| native rsipstack runtime and bounded mailboxes | `.58` build plus bounded mailbox, durable gate and directional Native Call patches | exact patch gates and direction-keyed UAS/UAC conformance; `.53` remains the exact controlled image/wire/latency/interop/capacity source | controlled host evidence at source `b63383b`; `.58` host requalification and live Native Authority remain `G03-E16/not_run` |
