...
function renderConfig(input: RustPbxRenderInput): string {
  return [
    '# Generated by the Converact Fabric RustPBX config renderer. Do not edit or commit.',
    ...
    'description = "Converact Fabric management adapter"',
    '',
    '[ami]',
...
function immutableImage(value: string): string {
  ...
  if (/(?:^|\/)restsend\/rustpbx(?::|@|$)/i.test(image)) {
    throw new Error('RUSTPBX_IMAGE must reference the Converact Fabric-patched RustPBX image, not upstream');
  }
