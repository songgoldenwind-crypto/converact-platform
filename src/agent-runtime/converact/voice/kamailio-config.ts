...
# Generated by Converact Fabric. Contains secret material; mode must remain 0600.
...
auto_aliases=no
${advertisedAliases}
server_header="Server: converact-sip-edge"
user_agent_header="User-Agent: converact-sip-edge"
enable_tls=yes
...
event_route[dispatcher:dst-down] {
    xlog("L_WARN", "converact dispatcher destination became unavailable\\n");
}

event_route[dispatcher:dst-up] {
    xlog("L_INFO", "converact dispatcher destination recovered\\n");
}
