...
} from './converact-controlled-provider.js';

export interface ConveractFabricProviderGovernanceAcceptanceCheck {
  name: string;
  status: 'passed' | 'failed';
  code: string;
}

export interface ConveractFabricProviderGovernanceAcceptanceReport {
  status: 'passed' | 'failed';
  verification_scope: 'controlled_provider_and_in_memory_governance';
  real_vendor_evidence: false;
  checks: ConveractFabricProviderGovernanceAcceptanceCheck[];
}
...
export async function runConveractFabricProviderGovernanceAcceptance(): Promise<ConveractFabricProviderGovernanceAcceptanceReport> {
  const checks: ConveractFabricProviderGovernanceAcceptanceCheck[] = [];
