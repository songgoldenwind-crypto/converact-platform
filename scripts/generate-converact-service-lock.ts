...
export function generateConveractFabricServiceLock(repoRootInput: string): PackageLock {
...
export function writeConveractFabricServiceLock(repoRoot: string): string {
  const lock = generateConveractFabricServiceLock(repoRoot);
...
if (invokedPath === fileURLToPath(import.meta.url)) {
  ...
  process.stdout.write(`${writeConveractFabricServiceLock(repoRoot)}\n`);
}
