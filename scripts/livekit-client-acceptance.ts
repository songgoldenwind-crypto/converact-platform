...
const CHECK_DESCRIPTIONS = {
  ...
  'led.sdk_room_join': 'Confirm LED uses the Converact Fabric HTTP SDK to create a room and obtain a Join Plan.',
  ...
  'reference_client.two_identity_lifecycle': 'Run the Converact Fabric reference client as two real identities through ring, accept, active and terminal states.',
