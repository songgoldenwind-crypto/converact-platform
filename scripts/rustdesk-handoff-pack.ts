...
export function renderRustDeskHandoffPack(config: RustDeskHandoffPackConfig): string {
  return [
    ...
    '## Client Acceptance',
    '',
    'Create the client configuration handoff and manual acceptance report template before the real client session, then fill evidence and audit exports after the session:',
    '',
    '```bash',
    ...
    '```',
    '',
    '真实客户端验收仍需要人工完成：安装客户端、填写 ID server/relay/key、打开 protocol URL 或公开 launch page、确认屏幕查看、键鼠、文件传输、剪贴板、录屏、授权撤销断开和旧链接失效。',
    '',
    '## Final Evidence Pack',
    '',
